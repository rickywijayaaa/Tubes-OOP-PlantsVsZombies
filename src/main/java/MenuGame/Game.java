...
public class Game {
    ...
    public static void play(Inventory inven) {
        ...
        Sun.setSun(500);
        Peta peta = new Peta();
        // Sunflower sun1 = new Sunflower(0,8);
        // Tile til1 = peta.getTile(0,8);
        // Sunflower sun3 = new Sunflower(0,6);
        // Tile til3 = peta.getTile(0,6);
        // Sunflower sun4 = new Sunflower(1,8);
        // Tile til4 = peta.getTile(1,8);
        // NormalZombie zom1 = new NormalZombie(1,7);
        // Tile til5 = peta.getTile(1,7);
        // Sunflower sun2 = new Sunflower(5,8);
        // Tile til2 = peta.getTile(5,8);
        // til1.addCreature(sun1);
        // til2.addCreature(sun4);
        // til3.addCreature(sun3);
        // til4.addCreature(sun2);
        // til5.addCreature(zom1);
        System.out.println("");
